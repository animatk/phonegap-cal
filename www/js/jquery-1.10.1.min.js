...
var openFB = (function() {
    ...
    function login(scope, success, error) {
		...
		oauthRedirectURL = 'https://irisdev.co/calendar_app/openfb.html';
		var fbAuthUrl = FB_LOGIN_URL + '?client_id=' + fbAppId + '&redirect_uri=' + oauthRedirectURL +'&response_type=token&display=popup&scope=' + scope;
		
		if (runningInCordova()) {
			window.location.href= fbAuthUrl;
		} else {
			setCookie('inwindow', 't', 365);
			window.open( fbAuthUrl , '_blank', 'location=no,width=640,height=480');
		}
	...
	*/
    ...
    function api(obj) {
        ...
        url = 'https://graph.facebook.com/v1.0' + obj.path + '?' + toQueryString(params);
