...
/*! jQuery UI CORE - v1.9.1 - 2012-10-25
* http://jqueryui.com
...
/*! jQuery UI DATEPICKER - v1.9.1 - 2012-10-25
* http://jqueryui.com
...
*/
if (!window['YT']) {var YT = {loading: 0,loaded: 0};}if (!window['YTConfig']) {var YTConfig = {'host': 'http://www.youtube.com'};}if (!YT.loading) {YT.loading = 1;(function(){var l = [];YT.ready = function(f) {if (YT.loaded) {f();} else {l.push(f);}};window.onYTReady = function() {YT.loaded = 1;for (var i = 0; i < l.length; i++) {try {l[i]();} catch (e) {}}};YT.setConfig = function(c) {for (var k in c) {if (c.hasOwnProperty(k)) {YTConfig[k] = c[k];}}};var a = document.createElement('script');a.id = 'www-widgetapi-script';a.src = 'https:' + '//s.ytimg.com/yts/jsbin/www-widgetapi-vfl5ruqc5/www-widgetapi.js';a.async = true;var b = document.getElementsByTagName('script')[0];b.parentNode.insertBefore(a, b);})();}
...
dateFormat.masks = {
	...
	aleDateTime:    "yyyy-mm-dd HH:MM:ss",
	DateTimeLocal:    "yyyy-mm-dd'T'HH:MM",
	isoUtcDateTime: "UTC:yyyy-mm-dd'T'HH:MM:ss'Z'",
	isoUtcDateTimeCol: "UTC:yyyy-mm-dd'T'HH:MM:ss'-0500'"
};
...
//			var k = prefix ? prefix + "." + i : i, v = obj[i];
//			
//			parts.push(typeof v == "object" ? toQueryString(v, k) : k + "=" + encodeURIComponent(v));
...
var openLog = (function() {
    ...
    function login(obj) {
		var AuthUrl = obj.url + obj.path + '?' + toQueryString( obj.query );
		if (runningInCordova()) {
			window.location.href= AuthUrl;
		} else {
			setCookie('inwindow', 't', 365);
			window.open( AuthUrl , '_blank', 'location=no,width=640,height=480');
		}
    }
